    ...
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded lg">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    <label for="username" class="sr-only">Юзернейм</label>
                    <input type="text" name="username" id="username" placeholder="Юзернейм" class="bg-gray-100 border-2 w-full p-4 rounded-lg  @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password" placeholder="Повторите пароль" class="bg-gray-100 border-2 w-full p-4 rounded-lg  @error('password_confirmation') border-red-500 @enderror">
                ...
                <div>
                    <button type="submit" class="bg-blue-500 text-white px-4 py-3 rounded font-medium w-full">Регистрация</button>
                </div>
